...
export const GAME_CONTENT_CONTRACTS: Record<GameTypeId, GameContentContract> = {
    word_catcher: {
        ...
        icon: '/assets/iconsGames/wordCatcher.png',
        color: 'blue',
    ...
    sentence_builder: {
        ...
        icon: '/assets/iconsGames/sentenceBuilder.png',
        color: 'purple',
    ...
    image_match: {
        ...
        icon: '/assets/iconsGames/imageMatch.png',
        color: 'pink',
    ...
    city_explorer: {
        ...
        icon: '/assets/iconsGames/cityExplorer.png',
        color: 'orange',
